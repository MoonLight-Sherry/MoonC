...
int main() {
	...
	scanf_s("%s", start);//输入初始状态 
	while (start[++i] != '0');//查找初始状态0的位置 
	scanf_s(start, "%d", &n);//字符串转换为整数 
	//int s=clock();
